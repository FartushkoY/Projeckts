...
public class homework2 {
    public static void main(String[] args) {
        ...
        System.out.println(findElement(arr1, 114, 0, arr1.length - 1));
        System.out.println(findElement(arr2, 114, 0, arr1.length - 1));

        int[] arr3 = {4, 7, 9, 2, 15, 14};
        System.out.println(findMax(arr3, 0, arr3[0]));

        Integer[] coins1 = {3, 2, 10, 2, 3};
        System.out.println(getResultTask3(coins1, 0, 16));
    }


    public static int findElement(int[] arr, int x, int indexStart, int indexEnd) {
        ...
        if (arr[indexMiddle] == x) {
            ...
            return findElement(arr, x, indexStart, indexEnd);
        } else {
    ...
    private static boolean getResultTask3(Integer[] coins, int i, int x) {
