...
//            add1of2Element(arr1, arr2, indArr1, indArr2, indArr3,sortArr);
        }
...
//            add1of2Element(arr1, arr3, indArr1, indArr3, indArr2, sortArr);
        }
...
//            add1of2Element(arr2, arr3, indArr2, indArr3, indArr1, sortArr);

        }
//        addRemainingElements(arr1, indArr1, indArr2, indArr3, sortArr);
//        addRemainingElements(arr2, indArr2, indArr1, indArr3, sortArr);
//        addRemainingElements(arr3, indArr3, indArr1, indArr2, sortArr);
    ...
    private static void add1of2Element(int[] arr1, int[] arr2, int indArr1, int indArr2, int indArr3,int[] sortArr) {
        while (indArr1 < arr1.length && indArr2 < arr2.length) {
            if (arr1[indArr1] <= arr2[indArr2]) {
                sortArr[indArr1 + indArr2 + indArr3] = arr1[indArr1];
//                indArr1++;
...
//                indArr2++;
    ...
    private static void addRemainingElements(int[] arr1, int indArr1, int indArr2, int indArr3, int[] sortArr) {
        while (indArr1 < arr1.length) {
            sortArr[indArr1 + indArr2 + indArr3] = arr1[indArr1];
            indArr1 = indArr1 + 1;
        }
