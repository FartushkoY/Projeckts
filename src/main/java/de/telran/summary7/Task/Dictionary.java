...
//        }
        ...
        Map<String, Long> dictionaryWithStream = Arrays.stream(words)
                .collect(Collectors.groupingBy(s -> s, TreeMap::new, Collectors.counting()));
        System.out.println(dictionaryWithStream);
...
//        }
        ...
        Set<Map.Entry<String, Long>> entries = dictionaryWithStream.entrySet();
